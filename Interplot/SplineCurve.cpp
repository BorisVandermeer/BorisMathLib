...
namespace Interplot
{
    ...
    void SplineCurve::setPoints(const std::vector<double> & x_list,const std::vector<double> & y_list){
        Spline::RefPoints points;
        vector<double> & s_list = points.x;
        assert(x_list.size()==y_list.size());
        size_t size = x_list.size();
    ...
    void SplineCurve::setPoints(const std::vector<double> & x_list,const std::vector<double> & y_list,double FromHeading,double ToHeading){
        Spline::RefPoints points;
        vector<double> & s_list = points.x;
        assert(x_list.size()==y_list.size());
        size_t size = x_list.size();
